...
CAN_MESSAGE<5> {Drive Bus, 0x2A1, Gen_Amps, Front_Fan_Amps, Rear_Fan_Amps, Front_Pump_Amps, Rear_Pump_Amps}};

MakeSignalSigned(float, 0, 16, 0.01, 0.0, True) bat_volt;
MakeSignalSigned(bool, 16, 8, 1.0, 0.0, True) bat_volt_warning;
CAN_MESSAGE<2> {Drive Bus, 0x2A2, Bat_Volt, Bat_Volt_Warning}};
...
CAN_MESSAGE<3> {Drive Bus, 0x203, Front_Brake_Pressure, Rear_Brake_Pressure, Brake_Pressed}};
...
CAN_MESSAGE<5> {Drive Bus, 0x204, Implausibility_Present, APPSs_Disagreement_Imp, BPPC_Imp, Brake_Invalid_Imp, APPSs_Invalid_Imp}};

MakeSignal(uint8_t, 0, 8, 1.0, 0.0) bms_command;
CAN_MESSAGE<1> {Drive Bus, 0x205, BMS_Command}};

MakeSignal(uint8_t, 0, 8, 1.0, 0.0) drive_state;
CAN_MESSAGE<1> {Drive Bus, 0x206, Drive_State}};

MakeSignalSigned(bool, 0, 1, 1.0, 0.0, True) active_aero_state;
MakeSignalSigned(int16_t, 1, 16, 1.0, 0.0, True) active_aero_position;
CAN_MESSAGE<2> {Drive Bus, 0x208, Active_Aero_State, Active_Aero_Position}};
...
CAN_MESSAGE<4> {Drive Bus, 0x209, Front_Pump_Duty_Cycle, Rear_Pump_Duty_Cycle, Front_Fan_Duty_Cycle, Rear_Pump_Duty_Cycle}};

MakeSignal(uint8_t, 0, 8, 1.0, 0.0) accel_lut_id_response;
CAN_MESSAGE<1> {Drive Bus, 0x20A, Accel_LUT_Id_Response}};
...
CAN_MESSAGE<3> {Drive Bus, 0x20B, IGBT_Temp_Limiting, Battery_Temp_Limiting, Motor_Temp_Limiting}};

MakeSignal(uint8_t, 0, 8, 1.0, 0.0) torque_status;
CAN_MESSAGE<1> {Drive Bus, 0x20C, Torque_Status}};
...
CAN_MESSAGE<3> {Drive Bus, 0x490, ECU_Enable_Response, BMS_Enable_Response, PDM_Enable_Response}};
...
CAN_MESSAGE<3> {Drive Bus, 0x491, Dynamics_Enable_Response, Front_Enable_Response, Telemetry_Enable_Response}};
...
CAN_MESSAGE<4> {Drive Bus, 0x492, BL_Enable_Response, BR_Enable_Response, FL_Enable_Response, FR_Enable_Response}};

MakeSignal(uint64_t, 0, 64, 1.0, 0.0) counter;
CAN_MESSAGE<1> {Drive Bus, 0x590, Counter}};

MakeSignal(uint64_t, 0, 64, 1.0, 0.0) counter;
CAN_MESSAGE<1> {Drive Bus, 0x591, Counter}};

MakeSignal(uint64_t, 0, 64, 1.0, 0.0) counter;
CAN_MESSAGE<1> {Drive Bus, 0x592, Counter}};

MakeSignal(uint64_t, 0, 64, 1.0, 0.0) counter;
CAN_MESSAGE<1> {Drive Bus, 0x593, Counter}};

MakeSignal(uint64_t, 0, 64, 1.0, 0.0) counter;
CAN_MESSAGE<1> {Drive Bus, 0x594, Counter}};

MakeSignal(uint64_t, 0, 64, 1.0, 0.0) counter;
CAN_MESSAGE<1> {Drive Bus, 0x595, Counter}};

MakeSignal(uint64_t, 0, 64, 1.0, 0.0) counter;
CAN_MESSAGE<1> {Drive Bus, 0x596, Counter}};

MakeSignal(uint64_t, 0, 64, 1.0, 0.0) counter;
CAN_MESSAGE<1> {Drive Bus, 0x597, Counter}};

MakeSignal(uint64_t, 0, 64, 1.0, 0.0) counter;
CAN_MESSAGE<1> {Drive Bus, 0x598, Counter}};

MakeSignal(uint64_t, 0, 64, 1.0, 0.0) counter;
CAN_MESSAGE<1> {Drive Bus, 0x599, Counter}};
...
CAN_MESSAGE<3> {Drive Bus, 0x192, ECU_Status, BMS_Status, PDM_Status}};
...
CAN_MESSAGE<3> {Drive Bus, 0x193, Dynamics_Status, Front_Status, Telemetry_Status}};
...
CAN_MESSAGE<4> {Drive Bus, 0x194, BL_Status, BR_Status, FL_Status, FR_Status}};
...
CAN_MESSAGE<5> {Drive Bus, 0x150, Max_Discharge_Current, Max_Regen_Current, Battery_Voltage, Battery_Temperature, Battery_Current}};
...
CAN_MESSAGE<11> {Drive Bus, 0x151, Fault_Summary, Undervoltage_Fault, Overvoltage_Fault, Undertemperature_Fault, Overtemperature_Fault, Overcurrent_Fault, External_Kill_Fault, Open_Wire_Fault, Open_Wire_Temp_Fault, Pec_Fault, Total_PEC_Failures}};
...
CAN_MESSAGE<7> {Drive Bus, 0x152, BMS_State, IMD_State, Max_Cell_Temp, Min_Cell_Temp, Max_Cell_Voltage, Min_Cell_Voltage, BMS_SOC}};
...
CAN_MESSAGE<8> {Drive Bus, 0x153, Cell_V_0, Cell_V_1, Cell_V_2, Cell_V_3, Cell_V_4, Cell_V_5, Cell_V_6, Cell_OCV_Offset_0}};
...
CAN_MESSAGE<8> {Drive Bus, 0x154, Cell_V_7, Cell_V_8, Cell_V_9, Cell_V_10, Cell_V_11, Cell_V_12, Cell_V_13, Cell_OCV_Offset_1}};
...
CAN_MESSAGE<8> {Drive Bus, 0x155, Cell_V_14, Cell_V_15, Cell_V_16, Cell_V_17, Cell_V_18, Cell_V_19, Cell_V_20, Cell_OCV_Offset_2}};
...
CAN_MESSAGE<8> {Drive Bus, 0x156, Cell_V_21, Cell_V_22, Cell_V_23, Cell_V_24, Cell_V_25, Cell_V_26, Cell_V_27, Cell_OCV_Offset_3}};
...
CAN_MESSAGE<8> {Drive Bus, 0x157, Cell_V_28, Cell_V_29, Cell_V_30, Cell_V_31, Cell_V_32, Cell_V_33, Cell_V_34, Cell_OCV_Offset_4}};
...
CAN_MESSAGE<8> {Drive Bus, 0x158, Cell_V_35, Cell_V_36, Cell_V_37, Cell_V_38, Cell_V_39, Cell_V_40, Cell_V_41, Cell_OCV_Offset_5}};
...
CAN_MESSAGE<8> {Drive Bus, 0x159, Cell_V_42, Cell_V_43, Cell_V_44, Cell_V_45, Cell_V_46, Cell_V_47, Cell_V_48, Cell_OCV_Offset_6}};
...
CAN_MESSAGE<8> {Drive Bus, 0x15A, Cell_V_49, Cell_V_50, Cell_V_51, Cell_V_52, Cell_V_53, Cell_V_54, Cell_V_55, Cell_OCV_Offset_7}};
...
CAN_MESSAGE<8> {Drive Bus, 0x15B, Cell_V_56, Cell_V_57, Cell_V_58, Cell_V_59, Cell_V_60, Cell_V_61, Cell_V_62, Cell_OCV_Offset_8}};
...
CAN_MESSAGE<8> {Drive Bus, 0x15C, Cell_V_63, Cell_V_64, Cell_V_65, Cell_V_66, Cell_V_67, Cell_V_68, Cell_V_69, Cell_OCV_Offset_9}};
...
CAN_MESSAGE<8> {Drive Bus, 0x15D, Cell_V_70, Cell_V_71, Cell_V_72, Cell_V_73, Cell_V_74, Cell_V_75, Cell_V_76, Cell_OCV_Offset_10}};
...
CAN_MESSAGE<8> {Drive Bus, 0x15E, Cell_V_77, Cell_V_78, Cell_V_79, Cell_V_80, Cell_V_81, Cell_V_82, Cell_V_83, Cell_OCV_Offset_11}};
...
CAN_MESSAGE<8> {Drive Bus, 0x15F, Cell_V_84, Cell_V_85, Cell_V_86, Cell_V_87, Cell_V_88, Cell_V_89, Cell_V_90, Cell_OCV_Offset_12}};
...
CAN_MESSAGE<8> {Drive Bus, 0x160, Cell_V_91, Cell_V_92, Cell_V_93, Cell_V_94, Cell_V_95, Cell_V_96, Cell_V_97, Cell_OCV_Offset_13}};
...
CAN_MESSAGE<8> {Drive Bus, 0x161, Cell_V_98, Cell_V_99, Cell_V_100, Cell_V_101, Cell_V_102, Cell_V_103, Cell_V_104, Cell_OCV_Offset_14}};
...
CAN_MESSAGE<8> {Drive Bus, 0x162, Cell_V_105, Cell_V_106, Cell_V_107, Cell_V_108, Cell_V_109, Cell_V_110, Cell_V_111, Cell_OCV_Offset_15}};
...
CAN_MESSAGE<8> {Drive Bus, 0x163, Cell_V_112, Cell_V_113, Cell_V_114, Cell_V_115, Cell_V_116, Cell_V_117, Cell_V_118, Cell_OCV_Offset_16}};
...
CAN_MESSAGE<8> {Drive Bus, 0x164, Cell_V_119, Cell_V_120, Cell_V_121, Cell_V_122, Cell_V_123, Cell_V_124, Cell_V_125, Cell_OCV_Offset_17}};
...
CAN_MESSAGE<8> {Drive Bus, 0x165, Cell_V_126, Cell_V_127, Cell_V_128, Cell_V_129, Cell_V_130, Cell_V_131, Cell_V_132, Cell_OCV_Offset_18}};
...
CAN_MESSAGE<8> {Drive Bus, 0x166, Cell_V_133, Cell_V_134, Cell_V_135, Cell_V_136, Cell_V_137, Cell_V_138, Cell_V_139, Cell_OCV_Offset_19}};
...
CAN_MESSAGE<8> {Drive Bus, 0x167, Cell_T_0, Cell_T_1, Cell_T_2, Cell_T_3, Cell_T_4, Cell_T_5, Cell_T_6, Cell_T_7}};
...
CAN_MESSAGE<8> {Drive Bus, 0x168, Cell_T_8, Cell_T_9, Cell_T_10, Cell_T_11, Cell_T_12, Cell_T_13, Cell_T_14, Cell_T_15}};
...
CAN_MESSAGE<8> {Drive Bus, 0x169, Cell_T_16, Cell_T_17, Cell_T_18, Cell_T_19, Cell_T_20, Cell_T_21, Cell_T_22, Cell_T_23}};
...
CAN_MESSAGE<8> {Drive Bus, 0x16A, Cell_T_24, Cell_T_25, Cell_T_26, Cell_T_27, Cell_T_28, Cell_T_29, Cell_T_30, Cell_T_31}};
...
CAN_MESSAGE<8> {Drive Bus, 0x16B, Cell_T_32, Cell_T_33, Cell_T_34, Cell_T_35, Cell_T_36, Cell_T_37, Cell_T_38, Cell_T_39}};
...
CAN_MESSAGE<8> {Drive Bus, 0x16C, Cell_T_40, Cell_T_41, Cell_T_42, Cell_T_43, Cell_T_44, Cell_T_45, Cell_T_46, Cell_T_47}};
...
CAN_MESSAGE<8> {Drive Bus, 0x16D, Cell_T_48, Cell_T_49, Cell_T_50, Cell_T_51, Cell_T_52, Cell_T_53, Cell_T_54, Cell_T_55}};
...
CAN_MESSAGE<8> {Drive Bus, 0x16E, Cell_T_56, Cell_T_57, Cell_T_58, Cell_T_59, Cell_T_60, Cell_T_61, Cell_T_62, Cell_T_63}};
...
CAN_MESSAGE<8> {Drive Bus, 0x16F, Cell_T_64, Cell_T_65, Cell_T_66, Cell_T_67, Cell_T_68, Cell_T_69, Cell_T_70, Cell_T_71}};
...
CAN_MESSAGE<8> {Drive Bus, 0x170, Cell_T_72, Cell_T_73, Cell_T_74, Cell_T_75, Cell_T_76, Cell_T_77, Cell_T_78, Cell_T_79}};

MakeSignal(uint64_t, 0, 64, 1.0, 0.0) controller_error;
CAN_MESSAGE<1> {Drive Bus, 0x004, Controller_Error}};

MakeSignal(uint64_t, 0, 64, 1.0, 0.0) controller_error_nack;
CAN_MESSAGE<1> {Drive Bus, 0x024, Controller_Error_NACK}};

MakeSignal(uint64_t, 0, 64, 1.0, 0.0) controller_error_protocol_violation;
CAN_MESSAGE<1> {Drive Bus, 0x00C, Controller_Error_Protocol_Violation}};
